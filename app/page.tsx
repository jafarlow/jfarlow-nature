  ...
  return (
    <main className='home'>
      <section className="content-block">
        ...
        <p>As mobile screens are smaller, that full screen view would be detrimental to the overall user experience, so the captions are listed below their respective images instead. Desktop & tablet users will need to trigger the full screen overlay to view the captions.</p>
