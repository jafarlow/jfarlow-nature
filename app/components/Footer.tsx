  ...
  return (
    <footer>
      <div className="footer-section">
        <img src="/jf-logo-white.png" alt="logo" className="footer-img" width={48} height={48}/>
        <p className="footer-text">
          Created by Jacob A Farlow
        </p>
        <div className="footer-icon-wrapper">
          <a href="https://github.com/jafarlow/" className="footer-icon" target="_blank" rel="external nofollow noopener noreferrer" aria-label="GitHub">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" width="80">
              <title>Visit Jacob's GitHub page</title>
          ...
          <a href="https://www.linkedin.com/in/jacob-farlow" className="footer-icon" target="_blank" rel="external nofollow noopener noreferrer" aria-label="LinkedIn">
            <svg id="Linkedin" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" width="80">
              <title>Visit Jacob's LinkedIn profile</title>
